...
type Propiedad struct {
	...
	Bedrooms    string `json:"bedrooms" db:"bedrooms" csv:"habitaciones"`
	Bathrooms   string `json:"bathrooms" db:"bathrooms" csv:"banios"`
	TotalArea   string `json:"total_area" db:"total_area" csv:"area"`
	CoveredArea string `json:"covered_area" db:"covered_area"`
}
