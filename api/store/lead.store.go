...
type LeadStorer interface {
    ...
    GetOne(string) (*models.Lead, error)
    Insert(*models.CreateLead) (*models.Lead, error)
    Update(*models.Lead, string) (*models.Lead, error)
}

type LeadMySqlStorage struct{
    Db *sqlx.DB
}

func (s *LeadMySqlStorage) GetAll() (*[]models.Lead, error){
    query := `SELECT 
...
func (s *LeadMySqlStorage) Insert(createLead *models.CreateLead) (*models.Lead, error){
...
func (s *LeadMySqlStorage) Update(lead *models.Lead, phone string) (*models.Lead, error){
